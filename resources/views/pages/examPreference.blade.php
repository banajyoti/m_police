...
<div class="px-4 grow flex flex-col">
    ...
    <div class="p-4 grow border border-gray-300 rounded-lg space-y-2">
        <p class="m-auto text-yellow-500 text-center rounded-md text-[0.65rem] md:text-sm font-medium">Candidates are
        ...
        <div class="flex flex-col items-center justify-center space-y-4">
            <form id="centrePreferenceForm" action="{{ route('centrePreference') }}" method="POST">
                ...
                <div class="mb-6 lg:w-[60vw] flex flex-col flex-wrap items-center">
                    <div class="p-2 border border-yellow-500 rounded-lg p-4 px-8">
                        <p class="mb-2 text-gray-600  text-center">Select the Test/Examination centers in which you want to appear<br>(Candidates can choose two Test/Exam centres)</p>
            ...
            <p class="text-gray-600">List of centres with preference order</p>
            <div class="lg:w-[60vw] md:grid grid-cols-12" id="post-preference-table">
