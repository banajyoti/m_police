                    ...
                    <div class="pl-2 flex flex-col justify-center">
                        ...
                        @if ($userDetails->high_qual == 1)
                      	...
                      	@elseif ($userDetails->high_qual == 2)
                            <p class="text-md text-gray-800 Nunito">HSSLC</p>
                      	@elseif ($userDetails->high_qual == 3)
                            <p class="text-md text-gray-800 Nunito">Diploma</p>
                      	@elseif ($userDetails->high_qual == 4)
                            <p class="text-md text-gray-800 Nunito">Graduate</p>
                      	@elseif ($userDetails->high_qual == 5)
                            <p class="text-md text-gray-800 Nunito">Post Graduate</p>
                        @endif
                    </div>
                </div>
                <div class="flex">
                    ...
                    <div class="pl-2 flex flex-col justify-center">
                        <p class="text-xs text-gray-500 font-medium">Tribe/Caste</p>
                        ...
                        @elseif ($userDetails->category_id == 4)
                            <p class="text-md text-gray-800 Nunito">ST</p>
                        @endif
                    </div>
                </div>
                <div class="flex">
        ...
        <div class="h-full space-y-2">
            <div class="p-4 grow border border-gray-300 rounded-lg flex">
                <div class="m-auto text-center space-y-3">
					...
					<p class="md:text-2xl text-green-600 font-medium">You have Successfully Applied</p>
