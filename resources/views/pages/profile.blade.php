...
<div class="px-4 grow flex flex-col">
    ...
    <form id="profile-form" action="" method="POST">
        ...
        <div class="p-4 grow border border-gray-300 rounded-lg space-y-8">
            <p class="m-auto text-yellow-500 text-center rounded-md text-[0.65rem] md:text-sm font-medium">Candidates
                need to fill out all the mandatory <span class="text-red-600">*</span> marked fields.</p>
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-2">
                        <div class="h-full flex flex-col">
                            <label for="can_name" class="block mb-auto px-1 text-sm font-medium text-gray-600">Candidate's Full
                                Name</label>
                    ...
                    <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-2">
                        <div class="h-full flex flex-col">
                            <label for="cast_cat"
                                class="block mb-auto px-1 text-sm font-medium text-gray-600">Tribe/Caste</label>
                    ...
                    <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-2">
                        <div class="h-full flex flex-col">
                            <label for="father_name"
                                class="block mb-auto px-1 text-sm font-medium text-gray-600">Father's Name</label>
                    ...
                    <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-2">
                        <div class="h-full flex flex-col">
                            <label for="mother_name"
                                class="block mb-auto px-1 text-sm font-medium text-gray-600">Mother's Name</label>
                    ...
                    <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-2">
                        <div class="h-full flex flex-col">
                            <label for="p_number" class="block mb-auto px-1 text-sm font-medium text-gray-600">Mobile Phone
                                Number</label>
                    ...
                    @if ($registerDetails->ex_ser == 1)
                        <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-2">
                            <div class="h-full flex flex-col">
                                <label for="start_date"
                                    class="block mb-auto px-1 text-sm font-medium text-gray-600">Service Start
                                    Date</label>
                                <input type="text" id="start_date" value="{{ $registerDetails->start_date }}"
                                    class="bg-gray-200  border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2"
                                    name="" required disabled />
                            </div>
                        </div>
                        <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-2">
                            <div class="h-full flex flex-col">
                                <label for="end_date"
                                    class="block mb-auto px-1 text-sm font-medium text-gray-600">Service End
                                    Date</label>
                                <input type="text" id="end_date" value="{{ $registerDetails->end_date }}"
                                    class="bg-gray-200  border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2"
                                    name="" required disabled />
                            </div>
                        </div>
                        <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-2">
                            <div class="h-full flex flex-col">
                                <label for="calculated_age"
                                    class="block mb-auto px-1 text-sm font-medium text-gray-600">Sevice Period</label>
                                <input type="text" id="calculated_age"
                                    value="{{ $registerDetails->calculated_age }}"
                                    class="bg-gray-200  border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2"
                                    name="" required disabled />
                            </div>
                        </div>
                    ...
                    <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-2">
                        <div class="h-full flex flex-col">
                            <label for="m_sport" class="block mb-auto px-1 text-sm font-medium text-gray-600">Are you
                                a Meritorious Sportspersons?</label>
                            <input type="text" id="m_sport"
                                value="{{ $registerDetails->m_sport == 1 ? 'YES' : 'NO' }}"
                                class="bg-gray-200  border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2"
                                name="" value="YES" required disabled />
                        </div>
                    </div>
                    @if ($registerDetails->m_sport == 1)
                        <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-2">
                            <div class="h-full flex flex-col">
                                <label for="m_sport"
                                    class="block mb-auto px-1 text-sm font-medium text-gray-600">Represented Games
                                    /Sports</label>
                                <input type="text" id="m_sport" value="{{ $registerDetails->g }}"
                                    class="bg-gray-200  border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2"
                                    name="" value="YES" required disabled />
                            </div>
                        </div>
                        <div class="col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-12">
                            <div class="h-full flex flex-col">
                                <label for="m_sport" class="block mb-auto px-1 text-sm font-medium text-gray-600">
                                    Categories of Meritorious Sportspersons?</label>
                                <input type="text" id="m_sport" value="{{ $registerDetails->gc }}"
                                    class="bg-gray-200  border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2"
                                    name="" value="YES" required disabled />
                            </div>
                        </div>
                    ...
                    <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-2">
                        <div class="h-full flex flex-col">
                            <label for="voter_no" class="block mb-auto px-1 text-sm font-medium text-gray-600">Voter
                                ID
                                Number (EPIC)<span class="ps-1 text-red-500">*</span></label>
                    ...
                    <div class="col-span-12 md:col-span-4 lg:col-span-3 xl:col-span-6">
                        <div class="h-full flex flex-col">
                            <label for="identity_mark"
                                class="block mb-auto px-1 text-sm font-medium text-gray-600">Identification
                                Mark<span class="ps-1 text-red-500">*</span></label>
                            <input type="text" id="identity_mark"
                                class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2"
                                name="identity_mark"
                                value="{{ old('identity_mark', $userProfiles->identity_mark ?? '') }}"
                                placeholder="Identification Marks" required />
                            @error('identity_mark')
                                <div class="text-sm text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-6 xl:col-span-3">
                        <div class="h-full flex flex-col">
                            <label for="p_village"
                                class="block mb-auto px-1 text-sm font-medium text-gray-600">Village / Locality<span
                                    class="ps-1 text-red-500">*</span></label>
                ...
                <div class="space-y-3">
                    <p class="text-md text-center">Highest Education Qualification</p>
                        ...
                        <div class="col-span-12 md:col-span-6 lg:col-span-3 xl:col-span-5">
                            <div class="h-full flex flex-col">
                                <label for="board_school"
                                    class="block mb-auto px-1 text-sm font-medium text-gray-600">Board/College/University<span
                                        class="ps-1 text-red-500">*</span></label>
