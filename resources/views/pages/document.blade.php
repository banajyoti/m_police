        ...
        <table class="min-w-full table-auto border-collapse border border-gray-300">
            ...
            <tbody>
                <tr class="border-b border-gray-300">
                    ...
                    <td class="p-2 flex justify-center items-center">
                        @if (isset($documents->photo) && !empty($documents->photo))
                            <img src="{{ asset('storage_main/public/uploads/upload_photo/' . $documents->photo) }}"
                ...
                <tr class="border-b border-gray-300">
                    ...
                    <td class="p-2 flex justify-center items-center">
                        @if (isset($documents->signature) && !empty($documents->signature))
                            <img src="{{ asset('storage_main/public/uploads/upload_signature/' . $documents->signature) }}"
                                alt="Uploaded Image" class="w-16 h-16 object-cover cursor-pointer"
                                onclick="enlargeImage(this)">
                        @else
                ...
                <tr class="border-b border-gray-300">
                    ...
                    <td class="p-2 border-r border-gray-300">
                        <p class="text-center md:text-start text-xs md:text-md ">Age proof Certificate (HSLC
                    ...
                    <td class="p-2 text-center">
                        @if (isset($documents->age_prof_cert) && !empty($documents->age_prof_cert))
                            <a href="#"
                                onclick="openPdfModal('{{ asset('storage_main/public/uploads/age_prof_cert/' . $documents->age_prof_cert) }}')"
                ...
                <tr class="border-b border-gray-300">
                    ...
                    <td class="p-2 border-r border-gray-300">
                        <p class="text-center md:text-start text-xs md:text-md ">HSLC Marksheet</p>
                        <p class="text-[0.65rem] md:text-xs text-red-500 text-center md:text-start">
                            PDF <br class="block md:hidden">(MAX. SIZE 200kb)
                        </p>
                    </td>
                    ...
                    <td class="p-2 text-center">
                        @if (isset($documents->class_x_cert) && !empty($documents->class_x_cert))
                            <a href="#"
                                onclick="openPdfModal('{{ asset('storage_main/public/uploads/class_x_cert/' . $documents->class_x_cert) }}')"
                                class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                    class="bi bi-eye text-xs pr-1"></i>view</a>
                        @else
                            <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
                    ...
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="p-2 text-center">
                            @if (isset($documents->mizu_lang_cert) && !empty($documents->mizu_lang_cert))
                                <a href="#"
                                    onclick="openPdfModal('{{ asset('storage_main/public/uploads/mizu_lang_cert/' . $documents->mizu_lang_cert) }}')"
                                    class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                        class="bi bi-eye text-xs pr-1"></i>view</a>
                            @else
                                <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
                    ...
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="p-2 text-center">
                            @if (isset($documents->mizu_class_x) && !empty($documents->mizu_class_x))
                                <a href="#"
                                    onclick="openPdfModal('{{ asset('storage_main/public/uploads/mizu_class_x/' . $documents->mizu_class_x) }}')"
                                    class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                        class="bi bi-eye text-xs pr-1"></i>view</a>
                            @else
                                <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
                ...
                @if ($questionaries && $questionaries->mizo_as_mil == 1)
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="p-2 border-r border-gray-300">
                            <p class="text-center md:text-start text-xs md:text-md ">HSLC / HSSLC marksheet for proof of MIL for applicants who studied outside Mizoram</p>
                            <p class="text-[0.65rem] md:text-xs text-red-500 text-center md:text-start">
                                PDF <br class="block md:hidden">(MAX. SIZE 200kb)
                            </p>
                        </td>
                        ...
                        <td class="p-2 text-center">
                            @if (isset($documents->mizu_class_x_outside) && !empty($documents->mizu_class_x_outside))
                                <a href="#"
                                    onclick="openPdfModal('{{ asset('storage_main/public/uploads/mizu_class_x_outside/' . $documents->mizu_class_x_outside) }}')"
                                    class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                        class="bi bi-eye text-xs pr-1"></i>view</a>
                            @else
                                <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
                ...
                @if ($questionaries && $questionaries->home_guard == 1)
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="p-2 border-r border-gray-300">
                            <p class="text-center md:text-start text-xs md:text-md ">Homeguard Employment Certificate
                            </p>
                            <p class="text-[0.65rem] md:text-xs text-red-500 text-center md:text-start">
                                PDF <br class="block md:hidden">(MAX. SIZE 200kb)
                            </p>
                        ...
                        <td class="p-2 text-center">
                            @if (isset($documents->homeguard_cert) && !empty($documents->homeguard_cert))
                                <a href="#"
                                    onclick="openPdfModal('{{ asset('storage_main/public/uploads/homeguard_cert/' . $documents->homeguard_cert) }}')"
                                    class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                        class="bi bi-eye text-xs pr-1"></i>view</a>
                            @else
                                <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
                ...
                @if (
                    ...
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="p-2 border-r border-gray-300">
                            <p class="text-center md:text-start text-xs md:text-md ">Tribe/Caste Certificate</p>
                            <p class="text-[0.65rem] md:text-xs text-red-500 text-center md:text-start">
                                PDF <br class="block md:hidden">(MAX. SIZE 200kb)
                            </p>
                        </td>
                        ...
                        <td class="p-2 text-center">
                            @if (isset($documents->caste_cert) && !empty($documents->caste_cert))
                                <a href="#"
                                    onclick="openPdfModal('{{ asset('storage_main/public/uploads/caste_cert/' . $documents->caste_cert) }}')"
                                    class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                        class="bi bi-eye text-xs pr-1"></i>view</a>
                            @else
                                <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
                    ...
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="p-2 text-center">
                            @if (isset($documents->ncc_cert) && !empty($documents->ncc_cert))
                                <a href="#"
                                    onclick="openPdfModal('{{ asset('storage_main/public/uploads/ncc_cert/' . $documents->ncc_cert) }}')"
                                    class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                        class="bi bi-eye text-xs pr-1"></i>view</a>
                            @else
                                <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
                ...
                @if ($questionaries && $questionaries->govt_servt == 1)
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="p-2 border-r border-gray-300 text-center"><label for="upload_govt_cert"
                                class="inline-block p-0 py-1 md:py-1 px-3 text-xs md:text-sm font-medium rounded md:rounded-full my-1 my-md-0 bg-blue-500 text-white hover:bg-blue-600 focus:ring-2 focus:ring-blue-400">
                                <i class="bi bi-cloud-arrow-up"></i> <br class="block md:hidden">UPLOAD
                            </label>
                            <input type="file" id="upload_govt_cert" name="govt_cert" class="hidden upload_doc"
                                data-id="govt_cert" accept=".pdf" onchange="uploadFile(event, 'govt_cert')">
                        </td>
                        <td class="p-2 text-center">
                            @if (isset($documents->govt_cert) && !empty($documents->govt_cert))
                                <a href="#"
                                    onclick="openPdfModal('{{ asset('storage_main/public/uploads/govt_cert/' . $documents->govt_cert) }}')"
                                    class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                        class="bi bi-eye text-xs pr-1"></i>view</a>
                            @else
                                <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
                    ...
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="p-2 text-center">
                            @if (isset($documents->mechanic_ex_cert) && !empty($documents->mechanic_ex_cert))
                                <a href="#"
                                    onclick="openPdfModal('{{ asset('storage_main/public/uploads/mechanic_ex_cert/' . $documents->mechanic_ex_cert) }}')"
                                    class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                        class="bi bi-eye text-xs pr-1"></i>view</a>
                            @else
                                <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
                    ...
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="p-2 text-center">
                            @if (isset($documents->iti_ex_cert) && !empty($documents->iti_ex_cert))
                                <a href="#"
                                    onclick="openPdfModal('{{ asset('storage_main/public/uploads/iti_ex_cert/' . $documents->iti_ex_cert) }}')"
                                    class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                        class="bi bi-eye text-xs pr-1"></i>view</a>
                            @else
                                <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
                    ...
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="p-2 text-center">
                            @if (isset($documents->ex_service) && !empty($documents->ex_service))
                                <a href="#"
                                    onclick="openPdfModal('{{ asset('storage_main/public/uploads/ex_service/' . $documents->ex_service) }}')"
                                    class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                        class="bi bi-eye text-xs pr-1"></i>view</a>
                            @else
                                <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
                    ...
                    <tr class="border-b border-gray-300">
                        ...
                        <td class="p-2 text-center">
                            @if (isset($documents->sports_cert) && !empty($documents->sports_cert))
                                <a href="#"
                                    onclick="openPdfModal('{{ asset('storage_main/public/uploads/sports_cert/' . $documents->sports_cert) }}')"
                                    class="text-blue-500 bg-gray-100 p-3 md:py-1.5 md:px-2 rounded"><i
                                        class="bi bi-eye text-xs pr-1"></i>view</a>
                            @else
                                <span class="bg-gray-100 py-2 px-1 rounded text-xs md:text-md inline-block">Not
...
@php
    ...
    $requiredFields = ['photo', 'signature', 'age_prof_cert', 'class_x_cert'];
    ...
    if ($questionaries && $questionaries->govt_servt == 1 && empty($documents->govt_cert)) {
        $anyFieldEmpty = true;
    }
@endphp
