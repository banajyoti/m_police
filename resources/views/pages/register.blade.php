...
<div class="grow md:p-4 grid lg:grid-cols-6 gap-3">
        ...
        <div class="h-full p-2 space-y-3">
            <div class=" text-center">
                <span class="text-xs poppins font-medium bg-yellow-400 px-2 py-1 rounded-lg block">
                    ...
                    before applying.
                    ( <a class="pl-1 text-[0.65rem] font-semibold text-blue-600 hover:text-blue-700"
                        href="{{ 'https://mizopolicerec.in/Advertisement.pdf' }}" target="_blank"><i
                            class="bi bi-download text-[0.65rem] pr-1"></i>ADVERTISEMENT</a> )
                </span>
            </div>
                    ...
                    <li class="space-y-2">
                        ...
                        <div class="ps-3">
                            <ul class="list-disc list-inside space-y-2">
                                ...
                                <li>
                                    Certificate of Tribe/Caste from Competent Authority.
                                </li>
                                <li>
                                    Certificate of NCC from Competent Authority (if applicable).
                                </li>
                                <li>
                                    Home Guards Employment Certificate issued by Competent Authority (if applicable).
                                </li>
                                <li>
                                    ...
                                    <div class="ps-3">
                                        <ol class="list-decimal list-inside">
                                            <li>
                                                Copy of Discharged Book/Certificate.
                                            </li>
                                        </ol>
                                    </div>
                                </li>
    ...
    <div class="lg:col-span-3 borde border-green-500">
        <div class="h-full p-2 space-y-6">
            ...
            <p class="text-xs font-medium text-center">
                All<span class="px-1 text-red-500 text-black text-base">*</span>marked fields are mandatory.
            </p>
            <form id="registrationForm" method="POST">
                @csrf
                <div class="grid grid-cols-6 sm:grid-cols-12 gap-4">
                    <div class="col-span-12 md:col-span-2 lg:col-span-3 xl:col-span-2">
                    ...
                    <div class="col-span-12 md:col-span-5 lg:col-span-9 xl:col-span-10">
                        <div class="h-full flex flex-col">
                            <label for="full_name"
                                class="block mb-auto px-1 text-sm font-medium text-gray-600">Candidate's Full Name<span
                                    class="ps-1 text-red-500">*</span></label>
                    ...
                    <div class="col-span-12 md:col-span-5 lg:col-span-6 xl:col-span-6">
                        <div class="h-full flex flex-col">
                            <label for="father_name"
                                class="block mb-auto px-1 text-sm font-medium text-gray-600">Father's
                                Name<span class="ps-1 text-red-500">*</span></label>
                    ...
                    <div class="col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6">
                        <div class="h-full flex flex-col">
                            <label for="mother_name"
                                class="block mb-auto px-1 text-sm font-medium text-gray-600">Mother's
                                Name<span class="ps-1 text-red-500">*</span></label>
                    ...
                    <div class="col-span-12 md:col-span-6 lg:col-span-8 xl:col-span-6">
                        <div class="h-full flex flex-col">
                    ...
                    <div id="category-field" class="col-span-12 md:col-span-3 lg:col-span-4 xl:col-span-6 hidden">
                        <div class="h-full flex flex-col">
                            <label for="cast_cat" class="block mb-auto px-1 text-sm font-medium text-gray-600">
                                Caste/Category <span class="ps-1 text-red-500">*</span>
                            </label>
                    ...
                    <div id="category-field-no" class="col-span-12 md:col-span-3 lg:col-span-4 xl:col-span-6 hidden">
                        <div class="h-full flex flex-col">
                            <label for="cast_cat" class="block mb-auto px-1 text-sm font-medium text-gray-600">
                                Tribe/Caste/Category <span class="ps-1 text-red-500">*</span>
                            </label>
                    ...
                    <div class="col-span-12 md:col-span-3 lg:col-span-5 xl:col-span-6">
                        <div class="h-full flex flex-col">
                            <label for="high_qual"
                    ...
                    <div class="col-span-12 md:col-span-3 lg:col-span-4 xl:col-span-3">
                        <div class="h-full flex flex-col">
                    ...
                    <div class="col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6">
                        <div class="h-full flex flex-col">
                            <label for="dob" class="block mb-aut px-1 text-sm font-medium text-gray-600">Age as
                                on 20-01-2025<span class="ps-1 text-red-500">*</span></label>
                            <input type="text" id="agee"
                                ...
                                name="age" placeholder="Age as on 20th January, 2025" readonly />
                    ...
                    <!-- Start Date -->
                    <div class="col-span-12 md:col-span-3 lg:col-span-4 xl:col-span-4" id="start_date_container"
                        style="display: none;">
                        <div class="h-full flex flex-col">
                            <label for="start_date" class="block mb-auto px-1 text-sm font-medium text-gray-600">Date
                                of entry into service<span class="ps-1 text-red-500">*</span></label>
                    ...
                    <!-- End Date -->
                    <div class="col-span-12 md:col-span-3 lg:col-span-4 xl:col-span-4" id="end_date_container"
                        style="display: none;">
                        <div class="h-full flex flex-col">
                            <label for="end_date" class="block mb-auto px-1 text-sm font-medium text-gray-600">Service
                                end
                    ...
                    <div class="col-span-12" id="date_error" style="display: none;">
                        <span class="text-sm text-red-600">Do ensure the start date is not greater than the end date.
                            Please correct it.</span>
                    </div>

                    <!-- Calculated Experience Display -->
                    <div class="col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-4" id="age_display"
                        style="display: none;">
                        <div class="h-full flex flex-col">
                            <label class="block mb-auto px-1 text-sm font-medium text-gray-600">Sevice Period</label>
                    ...
                    {{-- <div class="col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-6 sm:col-span-8">
                        <div class="h-full flex flex-col">
                    ...
                    <div class="col-span-12 md:col-span-6 lg:col-span-12 xl:col-span-6" id="ms">
                        <div class="h-full flex flex-col">
                    ...
                    <div id="sports-section" class="col-span-12 md:col-span-6 lg:col-span-12 xl:col-span-6 hidden">
                        <div class="h-full flex flex-col">
                    ...
                    <div id="categories-section"
                        class="col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-12 hidden">
                        <div class="h-full flex flex-col">
