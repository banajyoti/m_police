                    ...
                    <div class="col-span-3 sm:col-span-1 flex flex-col">
                        ...
                        <div class="grow lg:mt-3 sm:border-b-2 border-green-600">
                            ...
                            <p class="text-xs sm:text-xs md:text-md xl:text-base font-normal text-gray-700 pb-4">Apply
                                post as per eligibility criteria of Mizoram Police Recruitment.</p>
                        </div>
                    </div>
                    <div class="col-span-3 sm:col-span-1 flex flex-col">
                        <div class="flex items-center pb-4 xl:pb-10">
    ...
    <p class="text-base font-normal text-gray-700 border-b-2 border-green-600 pb-4">Download acknowledgement after completition on form for the selected post.</p>
            ...
            <div class="space-y-3">
                ...
                <div class="text-center">
                    <span class="inline-block p-1.5 rounded border border-2 border-red-600">
                        Candidates are requested to go through the complete advertisement and read the complete instructions before applying.
                    ( <a class="pl-1 text-[0.65rem] font-semibold text-blue-600 hover:text-blue-700" href="https://mizopolicerec.in/Advertisement.pdf" target="_blank"><i class="bi bi-download text-[0.65rem] pr-1"></i>ADVERTISEMENT</a> )
                    </span>
                </div>
                ...
                <div class="mb-4 sm:mb-10 px-0 px-lg-4">
                    <ul class="list-disc list-inside text-orange-700 font-medium">
                        ...
                        <li class="mb-3 poppins text-xs lg:text-base">
                            After successful registration candidates will get a Mizoram Police Recruitment ID.
                            Candidates will have to apply for any posts advertised through Mizoram Police during the year
          ...
          <div class="mb-8 sm:mb-4">
            <p class="m-0 text-medium text-sm text-center md:text-left">
              <span class="inline-block p-2 rounded-md bg-indigo-600 text-indigo-100 font-semibold">
                FEE STRUCTURE<br class="block md:hidden">
                <span class="inline-block p-1 rounded-md bg-indigo-100 text-indigo-700 mt-2 md:mt-0 ml-1">General: ₹ 400/-</span>
                <span class="inline-block p-1 rounded-md bg-indigo-100 text-indigo-700 mt-2 md:mt-0">OBC/SC/ST: ₹ 300/-</span>
              </span>
            </p>

          </div>
            <div class="mb-8 sm:mb-0">
                <a class="block p-2 rounded-lg text-sm text-center bg-blue-800 hover:bg-blue-900 text-white font-semibold"
