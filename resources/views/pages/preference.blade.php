...
<div class="px-4 grow flex flex-col">
    ...
    <div class="p-4 grow border border-gray-300 rounded-lg space-y-8">
        <p class="m-auto text-yellow-500 text-center rounded-md text-[0.65rem] md:text-sm font-medium">Candidates are
            requested to select the posts as per their preference</p>
        <div class="flex flex-col items-center justify-center space-y-">
            <div class="mb-8">
                <p class="mb-2 text-gray-600 text-center">Select posts that you want to apply<br>(Candidates can apply
                    more than one posts)</p>
            ...
            <p class="mb-4 text-gray-600 border-b">List of posts with preference order</p>
